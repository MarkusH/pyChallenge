# -*- coding: utf-8 -*-
#
# pyChallenge documentation build configuration file, created by
...
htmlhelp_basename = 'pyChallengedoc'
...
latex_documents = [
  ('index', 'pyChallenge.tex', u'pyChallenge Documentation',
   u'pyChallenge Team', 'manual'),
]
...
man_pages = [
    ('index', 'pychallenge', u'pyChallenge Documentation',
     [u'pyChallenge Team'], 1)]
